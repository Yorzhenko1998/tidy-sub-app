  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-[#020617] p-6 pb-24">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="grid grid-cols-3 gap-4 mb-6">
          {/* Weekly - Left */}
          <div className="text-center bg-white dark:bg-slate-800/40 dark:backdrop-blur-md border border-slate-200 dark:border dark:border-slate-700/40 rounded-2xl shadow-sm p-4">
            <p className="text-sm text-slate-900 dark:text-slate-100 mb-1">Weekly</p>
          ...
          <div className="text-center !bg-slate-800 dark:!bg-slate-800/40 dark:backdrop-blur-md rounded-2xl shadow-lg p-4 flex flex-col justify-center dark:border-blue-500/30 dark:shadow-[0_0_15px_rgba(59,130,246,0.1)]">
            <p className="text-sm !text-white mb-1">Monthly</p>
            ...
            <div className="relative">
              <ResponsiveContainer width="100%" height={300}>
                <PieChart>
                  ...
                  <Tooltip 
                    formatter={(value: number) => `${getCurrencySymbol(globalCurrency)}${value.toFixed(2)}`}
                    contentStyle={{
              ...
              {topSubscriptions.map((sub, index) => (
                <div key={sub.id} className="flex items-center justify-between">
                  ...
                  <span className="text-slate-900 dark:text-slate-100 font-semibold">
                    {getCurrencySymbol(globalCurrency)}{sub.monthlyAmount.toFixed(2)}/mo
                  </span>
                </div>
              ))}
            </div>
